function Start=Dep_Start(N_cluster, N_factor, Levels_in_factors)
    ...
    Start.level = normrnd(0,80,[1,N_cluster]);
    Start.factor = normrnd(0,80,[1,sum(Levels_in_factors)]);
    Start.factor_xi = gamrnd(0.1, 0.01, [1,N_factor]);
    Start.level_xi = gamrnd(0.1, 0.01, 1);
    Start.phi = gamrnd(0.1,0.01,1);
end
